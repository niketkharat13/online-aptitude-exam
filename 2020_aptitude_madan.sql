...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2020 at 03:18 PM
...
(1, 1, 'In Iterator, hasMoreElements() method of Enumeration has been changed to', 'hasNextElement()', 'isNext()', 'hasNext()', 'name remains same', 'hasNext()'),
...
(69, 3, 'Which of the following symbols are used for comments in Python?', '//', '/**/', '\"', '#', '#'),
(70, 1, 'Select the reserved keyword in python', 'Import', 'else', 'replace', 'All of the above', 'All of the above'),
(82, 3, 'Select the reserved keyword in python', 'import', 'else', 'raise', 'All of these\r\n', 'All of these\r\n'),
(83, 3, 'abcd', 'a', 'a', 'a', 'aaaa', 'a');
...
--
ALTER TABLE `question`
  MODIFY `q_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
